...
import { ILoadAccountByToken } from '@src/domain/usecases/account/ILoadAccountByToken'
import { DbLoadAccountByToken } from '@src/data/usecase/account/load-account-by-token/DbLoadAccountByToken'
